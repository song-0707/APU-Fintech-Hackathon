...
const CocoPanel: React.FC = () => {
  ...
  return (
    <section className="rounded-2xl border border-violet-200 dark:border-violet-900/50 bg-violet-50/40 dark:bg-violet-950/30 p-4 space-y-3">
      <div className="flex items-center gap-2 text-sm font-bold text-violet-700 dark:text-violet-300">
        ...
        <span className="font-normal text-violet-500 dark:text-violet-400">— grounded in past meetings</span>
      </div>
...
const RoomContent: React.FC<{
  ...
  return (
    <div data-meeting-recording-area className="space-y-5 p-4 pb-28 sm:p-6 sm:pb-28">
      ...
      {mediaError && <div className="flex items-start gap-2 rounded-xl border border-amber-200 dark:border-amber-900/60 bg-amber-50 dark:bg-amber-950/40 p-3 text-sm text-amber-800 dark:text-amber-300"><AlertCircle className="mt-0.5 h-4 w-4 shrink-0" />{mediaError}</div>}
